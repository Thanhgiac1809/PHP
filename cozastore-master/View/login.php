<section class="login-block " style="margin: 200px;">
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-4 login-sec">
                ...
                <div class="copy-text">Shop Giày<i class="fa fa-heart"></i> <a href="index.php?action=forgetps">Forget Password</a></div>
            </div>
        </div>
    </div>
    </div>
